#ifndef COIN_TREE_MODEL_H
#define COIN_TREE_MODEL_H
...
class Gazua::CoinTreeModel : public QAbstractItemModel {
Q_OBJECT
...
public:
    ...
    void setupModelData(const QStringList &lines, CoinTreeItem *parent);
};
